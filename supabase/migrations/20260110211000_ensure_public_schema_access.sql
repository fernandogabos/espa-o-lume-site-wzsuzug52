-- Ensure permissions for public schema ensuring access for all roles
-- This migration guarantees that the connection roles have the correct access rights
...
-- 5. Set DEFAULT PRIVILEGES for future objects to prevent permission issues on new tables
